...
def process_batch(batch: dict):
    ...
    with gzip.open(batch['input_metadata_path'], 'rb') as gz, open(batch['output_metadata_path'], 'wb') as f_out:
        ...
        for line in tqdm(f.readlines()):
            ...
            if (
                mag_field_of_study is None 
                or 'Computer Science' in mag_field_of_study
                or 'Business' in mag_field_of_study
...
if __name__ == '__main__':
    ...
    METADATA_OUTPUT_DIR = 'metadata/IS/'
    PDF_PARSES_INPUT_DIR = 'pdf_parses/raw/'
    PDF_PARSES_OUTPUT_DIR = 'pdf_parses/IS/'
